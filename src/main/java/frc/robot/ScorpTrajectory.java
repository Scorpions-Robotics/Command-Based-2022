...
public class ScorpTrajectory {
  ...
  public ScorpTrajectory(DriveSubsystem m_drive) {
    ...
    // Path Blue2BallsPosition1 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/blue2ball1position.wpilib.json");
    // Path Blue2BallsPosition2 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/blue2ball2position.wpilib.json");
    // Path Blue2BallsPosition3 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/blue2ball3position.wpilib.json");

    Path Blue3BallsPosition1 =
        Filesystem.getDeployDirectory().toPath().resolve("paths/Blue3BallsPosition1.wpilib.json");
    Path Blue3BallsPosition2 =
        Filesystem.getDeployDirectory().toPath().resolve("paths/Blue3BallsPosition2.wpilib.json");

    // Path Blue5BallsPath1 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/blue5ballpath1.wpilib.json");
    // Path Blue5BallsPath2 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/blue5ballpath2.wpilib.json");

    // Path Red2BallsPosition1 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red2ball1position.wpilib.json");
    // Path Red2BallsPosition2 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red2ball2position.wpilib.json");
    // Path Red2BallsPosition3 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red2ball3position.wpilib.json");

    // Path Red3BallsPosition1 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red3ball1position.wpilib.json");
    // Path Red3BallsPosition2 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red3ball2position.wpilib.json");

    // Path Red5BallsPath1 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red5ballpath1.wpilib.json");
    // Path Red5BallsPath2 =
    // Filesystem.getDeployDirectory().toPath().resolve("paths/red5ballpath2.wpilib.json");
