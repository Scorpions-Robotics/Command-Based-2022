...
public class IntakeSubsystem extends SubsystemBase {
  ...
  DoubleSolenoid intake_solenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, Constants.PNEUMATICS.intakeSolenoidForwardChannel, Constants.PNEUMATICS.intakeSolenoidReverseChannel);
