...
public class ShooterTurnNew extends CommandBase {
  ...
  public void execute() {
    ...
    if(controller.getSetpoint() - 10 < m_shooter.getShooterEncoderRPM() && controller.getSetpoint() + 10 > m_shooter.getShooterEncoderRPM()){
      new LEDCommand(m_led, Color.kAliceBlue).withTimeout(0.5).schedule();
    }
